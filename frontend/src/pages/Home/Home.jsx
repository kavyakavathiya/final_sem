...
const Home = () => {
  ...
  <div className={styles.cardWrapper}>
    <Card title="Welcome to MicroPod" icon="logo">
    <p className={styles.text}>
      MicroPod is a podcast application, where people can interact with each other and can talk about; be it sports, politics or academics.
